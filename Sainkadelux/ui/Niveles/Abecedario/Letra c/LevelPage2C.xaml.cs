...
public partial class LevelPage2C : ContentPage
{
    ...
    {
        FrameR.BackgroundColor = Color.FromArgb("#2760DB");
        FrameC.BackgroundColor = Color.FromArgb("#2760DB");
        FrameM.BackgroundColor = Color.FromArgb("#2760DB");
    }
    private async void SiguienteRetoCliecked(object sender, EventArgs e)
    {
        Navigation.InsertPageBefore(new UltimoLevelePageC(), this);
