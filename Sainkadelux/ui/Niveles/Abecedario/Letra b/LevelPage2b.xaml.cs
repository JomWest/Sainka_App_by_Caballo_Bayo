...
public partial class LevelPage2b : ContentPage
{
    ...
    {
        FrameG.BackgroundColor = Color.FromArgb("#2760DB");
        FrameB.BackgroundColor = Color.FromArgb("#2760DB");
        FrameO.BackgroundColor = Color.FromArgb("#2760DB");
    }
    private async void SiguienteRetoCliecked(object sender, EventArgs e)
    {
        Navigation.InsertPageBefore(new UltimoLevelPageb(), this);
